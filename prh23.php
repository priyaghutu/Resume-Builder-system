...
$db = mysqli_select_db($conn,DB_NAME) or die("Failed to connect to MySQL: " . mysqli_error());//selecting database from the established connection
 $sql2="SELECT * FROM workexperience3 WHERE username = '$x'"; //selecting all values from database table where username matches the entered username
...
$blank4= "Empty";
  ...
  if((!empty($h)&&!empty($i)&&!empty($j))||!empty($chk1))
 {
  ...
  $db = mysqli_select_db($conn,DB_NAME) or die("Failed to connect to MySQL: " . mysqli_error());//selecting database from the established connection
 $query = "update workexperience3 set from1 ='$arr', to1='$arr1',occupation='$l',name='$m',city='$n',country='$o',streetaddress='$p',postalcode='$q',dd1='$e',mm1='$f',yyyy1='$g',dd2='$h',mm2='$i',yyyy2='$j',chk1='$chk1',ch3='$ch3' where username='$x'";
...
<div class="center" id="mydiv">
  <form action="prh23.php" method="post">
