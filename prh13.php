...
if(empty($e)||empty($f)||empty($g))
{
  ...
  if((!empty($h)&&!empty($i)&&!empty($j))||!empty($chk1))
 {
  ...
  $db = mysqli_select_db($conn,DB_NAME) or die("Failed to connect to MySQL: " . mysqli_error());//selecting database from the established connection
    ...
    $query = "insert into workexperience3 values('$arr','$arr1','$l','$m','$n','$o','$p','$q','$x','$e','$f','$g','$h','$i','$j','$chk1','$ch3')";//insert in the same order as the database
...
<h1  id="mydiv1"align="center">WORK EXPERIENCE</h1>
...
<label for="From"><b>From</b></label>
 ...
 <pre><input type="search" name="DD1" list="exampleList3" placeholder="DD"  style="width:135px;" value="<?php if(!empty($e))echo $e; else ;?>" ><datalist id="exampleList3">
      <option value="1">1
</option>
      <option value="2" >2
</option>
...
<option value="31">31
  ...
  </datalist>     <input type="search" name="MM1" list="exampleList4" placeholder="MM"  style="width:135px;" value="<?php if(!empty($f))echo $f; else ;?>"><datalist id="exampleList4">
<option value="1">1
</option>
<option value="2" >2
</option>
...
<option value="12" >12
</option></datalist>     <input type="search" name="YYYY1" list="exampleList5" placeholder="YYYY"  style="width:135px;" value="<?php if(!empty($g))echo $g; else ;?>"><datalist id="exampleList5">
...
<option value="1989">1989
 ...
 <pre><input type="search" name="DD2" list="exampleList6" placeholder="DD"  style="width:135px;" id="d2" value="<?php if(!empty($h))echo $h; else ;?>"><datalist id="exampleList6">
      <option value="1">1
</option>
      <option value="2" >2
</option>
...
<option value="31">31
  ...
  </datalist>     <input type="search" name="MM2" list="exampleList7" placeholder="MM"  style="width:135px;" id='m2' value="<?php if(!empty($i))echo $i; else ;?>"><datalist id="exampleList7">
<option value="1">1
</option>
<option value="2" >2
</option>
...
<option value="12" >12
</option></datalist>     <input type="search" name="YYYY2" list="exampleList8" placeholder="YYYY"  style="width:135px;" id="y2" value="<?php if(!empty($j))echo $j; else ;?>"><datalist id="exampleList8">
...
<br>
       <input type="search" name="description" list="exampleList" placeholder="select from list or enter text" autocomplete=off style="width:500px;" value="<?php if(!empty($l))echo $l; else ;?>">
  ...
  <option value="Bartender">Bartender</option>
    ...
    <label for="Name">Name</label> <br>
     <input type="search" name="name" placeholder="Andersons And Dobbs Ltd" autocomplete=off style="width:500px;" value="<?php if(!empty($m))echo $m; else ;?>"><span class="error">* <?php if(!empty($blank2)) echo $blank2; else ;?></span><br><br>
    <pre><label for="City">City</label>                                                <label for="Country">Country</label> <br></pre>
    <pre><input type="search" name="City" placeholder="Kolkata" autocomplete=off  style="width:250px;" value="<?php if(!empty($n))echo $n; else ;?>"><span class="error">* <?php if(!empty($blank3)) echo $blank3; else ;?></span>          <input type="search" name="Country" list="example1List" placeholder="Country" autocomplete=off style="width:230px;"  value="<?php if(!empty($o))echo $o; else ;?>"><span class="error">* <?php if(!empty($blank4)) echo $blank4; else ;?></span>
...
<input type="search" name="streetaddress" placeholder="" autocomplete=off style="width:400px;" value="<?php if(!empty($p))echo $p; else ;?>"><br><br>
 <label for="Postal Code">Postal Code</label> <br>
<input type="search" name="postalcode" placeholder="" autocomplete=off style="width:400px;" value="<?php if(!empty($q))echo $q; else ;?>"><br><br></div>
<div class="center1">
 <pre><input type="submit" value="Submit" name="submit" target="p1" style="width:120px;" value="Submit">   <input type="cancel" value="Cancel" name="cancel" onclick ="window.location.href='frame_b2.php'" target="MainWindow" style="width:120px;"></pre></div>
</form>
</div>
</body>
</html>